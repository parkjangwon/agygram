...
The 0.1.1 bootstrap is pinned to stable tag `v0.1.1`, its exact commit, and verified release digests. Future releases update the version embedded in their bootstrap; rerunning the command then performs the SemVer update. Downgrades are refused unless explicitly authorized.
